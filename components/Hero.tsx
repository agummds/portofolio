  ...
  return (
    <div className="pb-20 pt-36">
      <div>
        ...
        <Spotlight className="top-23 left-80 h-[80vh] w-[50vw]" fill="yellow" />
      </div>

      <div className="h-screen w-full dark:bg-black-100 bg-white 
      dark:bg-grid-white/[0.2] bg-grid-black/[0.2] flex items-center justify-center
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center">
          <h2 className="upperacase tracking-widest text-xs text-center text-blue-100 max-w-80">
            Halo saya Agum
          </h2>
